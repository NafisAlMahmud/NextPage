...
const Home = () => {
  return (
    <div className="my-container flex flex-col items-center justify-between lg:flex-row px-4 lg:py-16 lg:max-w-screen-xl md:px-24 mx-auto">
      {/* Text Content */}
      <div className="mb-10 lg:max-w-screen-xl  lg:pr-5 lg:mb-0">
